<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comment_list.aspx.cs" Inherits="YueBonSoft.Web.admin.article.comment_list" ValidateRequest="false" %>
    ...
    <tr>
      <td class="comment">
        <div class="title">
          ...
          <%#new YueBonSoft.BLL.article().GetTitle(this.channel_id, Convert.ToInt32(Eval("article_id")))%>
        </div>
        <div class="ask">
