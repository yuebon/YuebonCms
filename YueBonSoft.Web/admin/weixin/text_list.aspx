<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="text_list.aspx.cs" Inherits="YueBonSoft.Web.admin.weixin.text_list" ValidateRequest="false" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a href="text_edit.aspx"><i class="iconfont icon-close"></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new YueBonSoft.BLL.weixin_account().GetName(Convert.ToInt32(Eval("account_id")))%></td>
    <td><%#Eval("keywords")%></td>
    <td><%#Utils.DropHTML( new YueBonSoft.BLL.weixin_request_content().GetContent(Convert.ToInt32(Eval("id"))), 30)%></td>
    <td>
