<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_article_spec.aspx.cs" Inherits="YueBonSoft.Web.admin.dialog.dialog_article_spec" %>
...
<script type="text/javascript">
    ...
    function createSpecHtml() {
        ...
        $(".spec-item li.selected").each(function (i) {
            specValueArr[i] = { 'pid': $(this).attr("pid"), 'pname': $(this).attr("pname"), 'id': $(this).attr("id"), 'value': $(this).attr("value").replace(/\"/g, "&#34;").replace(/\'/g, "&#39;"), 'img': $(this).attr("img") };
        });
        //如果不选择则清空
