...
namespace YueBonSoft.BLL
{
    ...
    public partial class article
    {
        ...
        /// 是否存在该记录
        /// </summary>
        public bool Exists(int channel_id, int article_id, string user_name)
        {
            ...
            return dal.Exists(channelName, article_id,user_name);
        }
        /// <summary>
        /// 增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public bool Delete(int channel_id, int article_id,string user_name)
        {
            string channelName = new BLL.site_channel().GetChannelName(channel_id);//查询频道名称
            if (string.IsNullOrEmpty(channelName))
            {
        ...
        /// 获取转发次数
        /// </summary>
        public int GetForwardNum(int channel_id, int article_id)
        {
            string channelName = new BLL.site_channel().GetChannelName(channel_id);//查询频道名称
            if (string.IsNullOrEmpty(channelName))
            {
            ...
            return dal.GetForwardNum(channelName, article_id);
        }

        /// <summary>
        /// 获取转发次数
        /// </summary>
        public int GetShareNum(int channel_id, int article_id)
        {
            string channelName = new BLL.site_channel().GetChannelName(channel_id);//查询频道名称
            if (string.IsNullOrEmpty(channelName))
            {
            ...
            return dal.GetShareNum(channelName, article_id);
        }
        /// <summary>
        /// 返回数据总数
        /// </summary>
