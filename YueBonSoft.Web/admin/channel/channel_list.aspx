<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="channel_list.aspx.cs" Inherits="YueBonSoft.Web.admin.channel.channel_list" ValidateRequest="false" %>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td><%#Eval("name")%></td>
      <td><%#Eval("title")%></td>
      <td><%#new YueBonSoft.BLL.sites().GetTitle(Convert.ToInt32(Eval("site_id")))%></td>
