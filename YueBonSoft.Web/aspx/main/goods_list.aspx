...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\" target='_self'>\r\n                                                        <img class=\"cover-image\" src=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" alt=\"" + Utils.ObjectToStr(dr["title"]) + "\">\r\n                                                    </a>\r\n                                                </figure>\r\n                                                <h4 class=\"widget-title\">\r\n                                                    <a href=\"");
	templateBuilder.Append(linkurl("goods_show",Utils.ObjectToStr(dr["id"])));

	templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\" target='_self'>" + Utils.ObjectToStr(dr["title"]) + "</a>\r\n                                                </h4>\r\n                                            </div>\r\n                                        </li>\r\n                                        ");
	}	//end for if
	...
	templateBuilder.Append("\r\n                                <li>\r\n                                    ");
	if (category_id==Utils.StrToInt(Utils.ObjectToStr(cdr2["id"]), 0))
	{
