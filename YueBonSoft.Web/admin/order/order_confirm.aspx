<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_confirm.aspx.cs" Inherits="YueBonSoft.Web.admin.order.order_confirm" ValidateRequest="false" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new YueBonSoft.BLL.site_payment().GetTitle(Convert.ToInt32(Eval("payment_id")))%></td>
    <td><%#new YueBonSoft.BLL.express().GetTitle(Convert.ToInt32(Eval("express_id")))%></td>
