...
{
    public partial class adv_edit : YueBonSoft.Web.UI.ManagePage
    {
        ...
        {
            DataTable dt = new YueBonSoft.BLL.sites().GetList(0, string.Empty, "sort_id asc,id desc").Tables[0];
