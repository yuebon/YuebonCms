<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sound_list.aspx.cs" Inherits="YueBonSoft.Web.admin.weixin.sound_list" ValidateRequest="false" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#Eval("keywords")%></td>
    <td><%#new YueBonSoft.BLL.weixin_request_content().GetContent(Convert.ToInt32(Eval("id")))%></td>
    <td>
