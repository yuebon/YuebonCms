<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bar_edit.aspx.cs" Inherits="YueBonSoft.Web.Plugin.Advert.admin.bar_edit" ValidateRequest="false" %>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#form1").initValidform();
        //初始化上传控件
        $(".upload-img").InitUploader({ sendurl: "../../../tools/upload_ajax.ashx", swf: "../../../scripts/webuploader/uploader.swf", filetypes: "jpg,jpge,png,gif,<%=sysConfig.videoextension %>" });
    });
</script>
</head>
...
<!--导航栏-->
<div class="location">
  <a href="bar_edit.aspx?aid=<%=this.aid %>" class="back"><i class="iconfont icon-up"></i><span>返回列表页</span></a>
