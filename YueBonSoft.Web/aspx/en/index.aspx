...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(Utils.ObjectToStr(config.webpath));
	templateBuilder.Append("scripts/owlcarousel2-2.2.1/assets/owl.carousel.min.css\" />\r\n    <link rel=\"stylesheet\" type=\"text/css\" href=\"");
	templateBuilder.Append("/templates/yanxuanen");
	...
	templateBuilder.Append("script>\r\n    <script type=\"text/javascript\" charset=\"utf-8\" src=\"");
	templateBuilder.Append(Utils.ObjectToStr(config.webpath));
	templateBuilder.Append("scripts/owlcarousel2-2.2.1/owlcarousel2-2.2.1.js\"></");
	templateBuilder.Append("script>\r\n    <script type=\"text/javascript\" charset=\"utf-8\" src=\"");
	templateBuilder.Append("/templates/yanxuanen");
	...
	templateBuilder.Append("\r\n                            <li class=\"col-lg-1 col-md-2  col-sm-2 col-xs-3\"><a href=\"");
	templateBuilder.Append(linkurl("partner_show",Utils.ObjectToStr(prdr["id"])));

	templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(prdr["title"]) + "\" target='_self' class=\"met-img\"><img class=\"cover-image\" src=\"" + Utils.ObjectToStr(prdr["img_url"]) + "\" title=\"" + Utils.ObjectToStr(prdr["title"]) + "\" alt=\"" + Utils.ObjectToStr(prdr["title"]) + "\"></a></li>\r\n                            ");
	}	//end for if
	...
	templateBuilder.Append("\" title=\"新闻中心\" target='_self'>新闻中心</a></h3>\r\n            <p class=\"desc animation-slide-top appear-no-repeat\" data-plugin=\"appear\" data-animate=\"fade\" data-repeat=\"false\">最新行业新闻资讯</p>\r\n\r\n            <div class=\"row\">\r\n                ");
