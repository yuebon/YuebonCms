<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="site_payment_list.aspx.cs" Inherits="YueBonSoft.Web.admin.order.site_payment_list" ValidateRequest="false" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new YueBonSoft.BLL.sites().GetTitle(Utils.StrToInt(Eval("site_id").ToString(),0))%></td>
    <td><%#Eval("ptitle")%></td>
