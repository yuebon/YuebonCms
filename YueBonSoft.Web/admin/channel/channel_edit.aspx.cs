...
namespace YueBonSoft.Web.admin.channel
{
    public partial class channel_edit : Web.UI.ManagePage
    {
        ...
        private string GetInherit(string page_type)
        {
            ...
            {
                case "index":
                    result = "YueBonSoft.Web.UI.Page.article";
                    break;
                case "category":
                    result = "YueBonSoft.Web.UI.Page.category";
                    break;
                case "list":
                    result = "YueBonSoft.Web.UI.Page.article_list";
                    break;
                case "detail":
                    result = "YueBonSoft.Web.UI.Page.article_show";
                    break;
            }
            return result;
        }
