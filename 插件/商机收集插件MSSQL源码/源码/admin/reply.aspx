<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reply.aspx.cs" Inherits="YueBonSoft.Web.Plugin.Feedback.admin.reply" ValidateRequest="false" %>
...
<div id="floatHead" class="content-tab-wrap">
  <div class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a class="selected" href="javascript:;">查看商机</a></li>
      </ul>
    </div>
  </div>
</div>
...
<div class="tab-content">
  <dl>
    <dt>所属站点</dt>
    <dd><%=new YueBonSoft.BLL.sites().GetTitle(model.site_id)%></dd>
  </dl>
  <dl>
    <dt>联系人</dt>
...
<div class="page-footer">
  <div class="btn-wrap">
    <asp:Button ID="btnSubmit" runat="server" Text="回复商机" CssClass="btn" onclick="btnSubmit_Click" />
