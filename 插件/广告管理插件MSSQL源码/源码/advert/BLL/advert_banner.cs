...
namespace YueBonSoft.Web.Plugin.Advert.BLL
{
    /// <summary>
    /// 广告Banner
    /// </summary>
    ...
    {
        private readonly YueBonSoft.Model.sysconfig sysConfig = new YueBonSoft.BLL.sysconfig().loadConfig(); //获得站点配置信息
        private readonly DAL.advert_banner dal;
        public advert_banner()
        {
            dal = new DAL.advert_banner(sysConfig.sysdatabaseprefix);
        }
