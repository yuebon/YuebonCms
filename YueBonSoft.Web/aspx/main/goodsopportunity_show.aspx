...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	string category_title = get_category_title(model.category_id,"货源");
	...
	templateBuilder.Append("script>次</span>\r\n                            <span>\r\n                                <i class=\"iconfontx icon-redo\"></i>转发" + Utils.ObjectToStr(model.fields["ForwardNum"]) + "次\r\n                            </span>\r\n                            <span>\r\n                                <i class=\"iconfontx icon-pengyouquan\"></i>分享" + Utils.ObjectToStr(model.fields["sharenum"]) + "次\r\n                            </span>\r\n                            <span><i class=\"iconfont icon-msg\"></i>评论\r\n                            <script type=\"text/javascript\" src=\"");
	templateBuilder.Append(Utils.ObjectToStr(config.webpath));
	...
	string senddate = Utils.ObjectToStr(model.fields["sendDate"]);
	...
	templateBuilder.Append("\r\n                        <p class=\"introb\">" + Utils.ObjectToStr(model.fields["ExpressLine"]) + "</p>\r\n                        <p class=\"intro\">重量：" + Utils.ObjectToStr(model.fields["GoodsWeight"]) + "&nbsp;&nbsp; 体积：" + Utils.ObjectToStr(model.fields["GoodsVolume"]) + "</p>\r\n                        <p class=\"intro\">期望运费：" + Utils.ObjectToStr(model.fields["ExpectMoney"]) + "</p>\r\n                        <p class=\"intro\">电话：<a href=\"tel:" + Utils.ObjectToStr(model.fields["telphone"]) + "\">" + Utils.ObjectToStr(model.fields["telphone"]) + "</a></p>\r\n                        <p class=\"intro\">手机：<a href=\"tel:" + Utils.ObjectToStr(model.fields["mobile"]) + "\">" + Utils.ObjectToStr(model.fields["mobile"]) + "</a></p>\r\n                        <p class=\"intro\">联系人：" + Utils.ObjectToStr(model.fields["contact"]) + "</p>\r\n                        <p class=\"intro\">地址：<a href=\"http://apis.map.qq.com/uri/v1/search?keyword=" + Utils.ObjectToStr(model.fields["address"]) + "&referer=dfkcmap&region=上海\">" + Utils.ObjectToStr(model.fields["address"]) + "</a></p>\r\n                        <p class=\"introsenddate\">发货日期：<span class=\"ftclred\">");	templateBuilder.Append(Utils.ObjectToDateTime(Utils.ObjectToStr(model.fields["sendDate"])).ToString("MM月dd日"));

	templateBuilder.Append("</span></p>\r\n                        <p class=\"meta-add-date\">\r\n                            <span>");	templateBuilder.Append(Utils.ObjectToDateTime(model.add_time).ToString("MM-dd HH:MM"));

	templateBuilder.Append("发布</span>\r\n                        </p>\r\n                    </div>\r\n                    <div class=\"entry\">\r\n                        ");
	if (model.img_url!="")
	{
	...
	templateBuilder.Append("\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <!--/资讯介绍-->\r\n            <!--相关资讯-->\r\n            <div class=\"weui-panel weui-panel_access\">\r\n                <div class=\"weui-panel__hd\">相关货源</div>\r\n                <div class=\"weui-panel__bd\">\r\n                    <div class=\"txt-list\">\r\n                        <ul>\r\n                            ");
