<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adv_view.aspx.cs" Inherits="YueBonSoft.Web.Plugin.Advert.admin.adv_view" %>
...
<!--导航栏-->
<div class="location">
  <a href="adv_list.aspx" class="back"><i class="iconfont icon-up"></i><span>返回列表页</span></a>
...
<div class="tab-content">
  ...
  <dl>
    <dt>复制代码</dt>
    <dd>
      <textarea id="txtCopyUrl" class="input" style="vertical-align:middle;"><script type="text/javascript" src="<%=sysConfig.webpath%>plugins/advert/advert_js.ashx?id=<%=model.id%>"></script></textarea>
  ...
  <dl>
    ...
    <dd>
      <div style="color:#060;">
            ...
            2、幻灯片类型的广告依赖于Jquery框架，请在页面引用方可正常显示；<br />
