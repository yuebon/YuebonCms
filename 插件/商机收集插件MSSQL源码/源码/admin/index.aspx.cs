...
namespace YueBonSoft.Web.Plugin.Feedback.admin
{
    public partial class index : YueBonSoft.Web.UI.ManagePage
    {
        ...
        protected void lbtnUnLock_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(DTEnums.ActionEnum.Audit.ToString(), "审核商机插件内容"); //记录日志
        ...
        protected void lbtnDelete_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(DTEnums.ActionEnum.Delete.ToString(), "删除商机成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
