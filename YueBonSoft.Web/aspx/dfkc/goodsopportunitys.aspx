...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	DataTable newsList = get_article_list(channel, 0, 50, "status=0 and img_url<>''");
	...
	templateBuilder.Append("\r\n                        <li>\r\n                            <a href=\"");
	templateBuilder.Append(linkurl("goodsopportunity_show",Utils.ObjectToStr(newdr["id"])));

	templateBuilder.Append("\">\r\n                                ");
	string senddate = Utils.ObjectToStr(newdr["sendDate"]);
	...
	if (Utils.ObjectToStr(newdr["img_url"])!="")
	{

	templateBuilder.Append("\r\n                                <img src=\"" + Utils.ObjectToStr(newdr["img_url"]) + "\" />\r\n                                ");
	}	//end for if

	templateBuilder.Append("\r\n                                <h2>" + Utils.ObjectToStr(newdr["title"]) + "</h2>\r\n                                <p class=\"introb\">" + Utils.ObjectToStr(newdr["ExpressLine"]) + "</p>\r\n                                <p class=\"intro\">重量：" + Utils.ObjectToStr(newdr["GoodsWeight"]) + "&nbsp;&nbsp; 体积：" + Utils.ObjectToStr(newdr["GoodsVolume"]) + "</p>\r\n                                <p class=\"intro\">电话：" + Utils.ObjectToStr(newdr["telphone"]) + "</p>\r\n                                <p class=\"intro\">手机：" + Utils.ObjectToStr(newdr["mobile"]) + "</p>\r\n                                <p class=\"intro\">联系人：" + Utils.ObjectToStr(newdr["contact"]) + "</p>\r\n                                <p class=\"intro\">发货时间：");	templateBuilder.Append(Utils.ObjectToDateTime(Utils.ObjectToStr(newdr["sendDate"])).ToString("yyyy年MM月dd日HH时"));

	templateBuilder.Append("</p>\r\n                                <p class=\"intro\">发布时间：");	templateBuilder.Append(Utils.ObjectToDateTime(Utils.ObjectToStr(newdr["add_time"])).ToString("yyyy年MM月dd日HH:MM"));
	...
	templateBuilder.Append("\r\n                        <li>\r\n                            <a href=\"");
	templateBuilder.Append(linkurl("goodsopportunity_show",Utils.ObjectToStr(hotdr["id"])));
