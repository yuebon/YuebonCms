<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="picture_list.aspx.cs" Inherits="YueBonSoft.Web.admin.weixin.picture_list" ValidateRequest="false" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a href="picture_edit.aspx"><i class="iconfont icon-close"></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center">
      <%#new YueBonSoft.BLL.weixin_request_content().GetCount(Convert.ToInt32(Eval("id")))%> 条
    </td>
