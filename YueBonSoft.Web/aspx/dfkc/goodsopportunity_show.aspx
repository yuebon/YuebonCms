...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(Utils.ObjectToStr(model.title));
	templateBuilder.Append("</h1>\r\n                    <p class=\"meta-info\">\r\n                        <span><i class=\"iconfont icon-view\"></i>浏览<script type=\"text/javascript\" src=\"");
	...
	templateBuilder.Append("\"></");
	templateBuilder.Append("script>次</span>\r\n                        <span><i class=\"iconfont icon-redo\"></i>转发<script type=\"text/javascript\" src=\"");
	templateBuilder.Append(Utils.ObjectToStr(config.webpath));
	templateBuilder.Append("tools/submit_ajax.ashx?action=redo_article_count&channel_id=");
	templateBuilder.Append(Utils.ObjectToStr(model.channel_id));
	templateBuilder.Append("&id=");
	templateBuilder.Append(Utils.ObjectToStr(model.id));
	templateBuilder.Append("\"></");
	templateBuilder.Append("script>次</span>\r\n                        <span><i class=\"iconfont icon-pengyouquan\"></i>分享<script type=\"text/javascript\" src=\"");
	templateBuilder.Append(Utils.ObjectToStr(config.webpath));
	templateBuilder.Append("tools/submit_ajax.ashx?action=pengyouquan_article_count&channel_id=");
	templateBuilder.Append(Utils.ObjectToStr(model.channel_id));
	templateBuilder.Append("&id=");
	templateBuilder.Append(Utils.ObjectToStr(model.id));
	templateBuilder.Append("&click=1\"></");
	templateBuilder.Append("script>次</span>                        \r\n                        <span><i class=\"iconfont icon-msg\"></i>评论<script type=\"text/javascript\" src=\"");
	templateBuilder.Append(Utils.ObjectToStr(config.webpath));
	...
	templateBuilder.Append("\r\n                        <a href=\"#\"><i class=\"datetip\">已过期</i></a>\r\n                        ");
	}	//end for if

	templateBuilder.Append("\r\n                        <p class=\"introb\">" + Utils.ObjectToStr(model.fields["ExpressLine"]) + "</p>\r\n                        <p class=\"intro\">重量：" + Utils.ObjectToStr(model.fields["GoodsWeight"]) + "&nbsp;&nbsp; 体积：" + Utils.ObjectToStr(model.fields["GoodsVolume"]) + "</p>\r\n                        <p class=\"intro\">电话：" + Utils.ObjectToStr(model.fields["telphone"]) + "</p>\r\n                        <p class=\"intro\">手机：" + Utils.ObjectToStr(model.fields["mobile"]) + "</p>\r\n                        <p class=\"intro\">联系人：" + Utils.ObjectToStr(model.fields["contact"]) + "</p>\r\n                        <p class=\"introsenddate\">发货时间：");	templateBuilder.Append(Utils.ObjectToDateTime(Utils.ObjectToStr(model.fields["sendDate"])).ToString("yyyy年MM月dd日HH时"));
