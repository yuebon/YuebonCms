...
{
    public partial class reply : YueBonSoft.Web.UI.ManagePage
    {
        private int id = 0;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            bll.Update(model);
            AddAdminLog(DTEnums.ActionEnum.Reply.ToString(), "回复商机插件内容：" + model.title); //记录日志
            JscriptMsg("商机回复成功！", "index.aspx");
        }
