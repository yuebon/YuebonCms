<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="attribute_field_edit.aspx.cs" Inherits="YueBonSoft.Web.admin.channel.attribute_field_edit" ValidateRequest="false" %>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList ID="ddlControlType" runat="server" datatype="*" 
              ...
              <asp:ListItem Value="select-area">地区级联</asp:ListItem>
          </asp:DropDownList>
       </div>
     </dd>
  </dl>
    ...
    <dd>
      <div class="rule-multi-radio">
          <asp:RadioButtonList ID="rblEditorType" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
              ...
              <asp:ListItem Value="135">135编辑器</asp:ListItem>
          </asp:RadioButtonList>
      </div>
    </dd>
  </dl>
